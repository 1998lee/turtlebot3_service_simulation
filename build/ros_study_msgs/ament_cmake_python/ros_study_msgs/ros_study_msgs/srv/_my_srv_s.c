...
bool ros_study_msgs__srv__my_srv__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tblno
    PyObject * field = PyObject_GetAttrString(_pymsg, "tblno");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tblno = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * ros_study_msgs__srv__my_srv__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // tblno
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tblno);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tblno", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
bool ros_study_msgs__srv__my_srv__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // ordno
    PyObject * field = PyObject_GetAttrString(_pymsg, "ordno");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ordno = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // timer
    PyObject * field = PyObject_GetAttrString(_pymsg, "timer");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->timer = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // success
...
PyObject * ros_study_msgs__srv__my_srv__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // ordno
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ordno);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ordno", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // timer
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->timer);
    {
      int rc = PyObject_SetAttrString(_pymessage, "timer", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
