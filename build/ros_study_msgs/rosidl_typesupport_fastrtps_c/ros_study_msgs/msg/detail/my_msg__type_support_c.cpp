...
#include "ros_study_msgs/msg/detail/my_msg__rosidl_typesupport_fastrtps_c.h"
...
using _MyMsg__ros_msg_type = ros_study_msgs__msg__MyMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cancel
  {
    cdr << (ros_message->cancel ? true : false);
  }

  // Field name: tableno
  {
    cdr << ros_message->tableno;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cancel
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->cancel = tmp ? true : false;
  }
...
size_t get_serialized_size_ros_study_msgs__msg__MyMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name cancel
  {
    size_t item_size = sizeof(ros_message->cancel);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name tableno
  {
    size_t item_size = sizeof(ros_message->tableno);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _MyMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_study_msgs__msg__MyMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t max_serialized_size_ros_study_msgs__msg__MyMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs__msg__MyMsg;
    is_plain =
      (
      offsetof(DataType, tableno) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MyMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_study_msgs__msg__MyMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, msg, MyMsg)() {
