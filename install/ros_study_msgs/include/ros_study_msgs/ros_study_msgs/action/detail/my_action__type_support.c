...
static rosidl_typesupport_introspection_c__MessageMember ros_study_msgs__action__MyAction_Goal__rosidl_typesupport_introspection_c__MyAction_Goal_message_member_array[2] = {
  {
    "location",  // name
    ...
    offsetof(ros_study_msgs__action__MyAction_Goal, location),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_study_msgs__action__MyAction_Goal, wait_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
